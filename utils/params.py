...
def build_args():
    ...
    parser.add_argument('--dec_in_dim', type=int, default=512)
    parser.add_argument('--lr_coder', type=float, default=0.0005)
    parser.add_argument('--lr_fc', type=float, default=0.0006)
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--lr_wait_coder', type=float, default=0.0001)
    parser.add_argument('--lr_wait_fc', type=float, default=0.001)
    parser.add_argument('--mae_epochs', type=int, default=400)
    parser.add_argument('--replace_rate', type=float, default=0.0)
    parser.add_argument('--leave_unchanged', type=float, default=0.0)
    parser.add_argument('--feat_mask_rate', type=str, default="0.1,0.0005,0.8")
    parser.add_argument('--enc_dec_input_dim', type=int, default=1140, help="number of model dims")
